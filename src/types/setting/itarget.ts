...
import { ResultType, TargetModel,FileItemShare,PageRequest, } from '../../base/model';
import { XTarget, XTargetArray,XIdentity } from '../../base/schema';
...
export interface IMTarget {
  /** 我加入的市场 */
  joinedMarkets: IMarket[];
  /** 开放市场 */
  publicMarkets: IMarket[];
  /** 拥有的产品/应用 */
